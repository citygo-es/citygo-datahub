 SELECT geo_locations.coords,
  ...
  WHERE attractions.visible = true AND attractions.type::text = 'PointOfInterest'::text AND data_resource_categories.category_id = 15 AND data_resource_categories.data_resource_type::text = 'PointOfInterest'::text AND tags.name::text = 'Werkstatt / Reparatur'::text;
